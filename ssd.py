...
def SSD300(input_shape, num_classes=21):
    ...
    net['conv7_2'] = Conv2D(256, (3, 3), strides=(2, 2), activation="relu", name="conv7_2", padding="valid")(net['conv7_2'])
    # Block 8
    net['conv8_1'] = Conv2D(128, (1, 1), activation="relu", name="conv8_1", padding="same")(net['conv7_2'])
    net['conv8_2'] = Conv2D(256, (3, 3), strides=(2, 2), activation="relu", name="conv8_2", padding="same")(net['conv8_1'])
    # Last Pool
